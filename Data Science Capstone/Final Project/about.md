...
#### Note:
The source codes for ui.R and server.R files are also available on the [GitHub repo](https://github.com/RicardoDeGouveia/DataScienceCoursera/tree/master/Data%20Science%20Capstone)
